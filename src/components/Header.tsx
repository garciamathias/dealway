...
export const InternalHeader = () => {
    ...
    return (
        <header>
            <nav className="fixed top-0 z-50 w-full bg-white/95 backdrop-blur-lg border-b border-gray-200/30 shadow-sm">
                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-4 sm:gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                            ...
                            <button
                                ...
                                <Menu className={cn("m-auto size-6 duration-200 text-gray-700", menuState && "rotate-180 scale-0 opacity-0")} />
                                <X className={cn("absolute inset-0 m-auto size-6 duration-200 text-gray-700 -rotate-180 scale-0 opacity-0", menuState && "rotate-0 scale-100 opacity-100")} />
                            </button>
                        </div>
                        ...
                        <div className={cn("bg-white mb-6 w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-1.5 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none", menuState ? "flex" : "hidden lg:flex")}>
